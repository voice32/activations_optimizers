...
model_name = 'cifar10_'+ mode +'_last_dense_' + str(experiment)


print('-'*30)
print('Randomized ' + mode + ' activations on last dense layer')
model_name = 'cifar10_rand_all_last_dense_' + str(experiment)
dense_units = 512
